  ...
  head: () => ({
    meta: [
      ...
      { title: "TradeMind AI — Trade Smarter with AI" },
      {
        name: "description",
        content:
          "AI-powered crypto futures analysis that explains every opportunity with reasoning, probability, confidence and risk.",
      },
      ...
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/98eee8ec-a6ef-45ee-a6b9-379cc8bff3d0/id-preview-182dbe2a--630c7486-cdb0-499e-b68b-81716a978521.lovable.app-1785334413981.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/98eee8ec-a6ef-45ee-a6b9-379cc8bff3d0/id-preview-182dbe2a--630c7486-cdb0-499e-b68b-81716a978521.lovable.app-1785334413981.png" },
    ],
    links: [
      {
        rel: "stylesheet",
